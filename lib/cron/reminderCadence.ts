/**
 * PRD-74 Phase 2 — reminder cadence anchored to intake_submitted_at.
 *
 ...
 * relative to the application's intake_submitted_at — NOT wall-clock now —
 * so a delayed or restarted cron run does not slide the schedule.
 */
