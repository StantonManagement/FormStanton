...
export const pbvFullAppTranslations: Record<PreferredLanguage, PbvFullAppStrings> = {
  en: {
    ...
    all_requirements_met: "You've sent us everything — we're reviewing it now.",
  ...
  es: {
    ...
    all_requirements_met: 'Ya nos envió todo — lo estamos revisando.',
  ...
  pt: {
    ...
    all_requirements_met: 'Você já nos enviou tudo — estamos revisando.',
