    ...
    return buildings.map(building => {
      ...
      const records: ComplianceRecord[] = subs.map(s => {
        ...
        return {
          ...
          tenant_picked_up: s.tenant_picked_up ?? false,
          permit_entered_in_appfolio: s.permit_entered_in_appfolio ?? false,
          pickup_id_photo: s.pickup_id_photo ?? null,
          pickup_id_uploaded_to_appfolio: s.pickup_id_uploaded_to_appfolio ?? false,
          permit_revoked: s.permit_revoked ?? false,
