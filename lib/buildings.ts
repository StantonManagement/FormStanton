...
export const buildingUnits: Record<string, string[]> = {
  "90 Park Street": ["1", "2", "3", "4", "5 - A", "5 - B", "5 - C", "5 - D", "5 - E", "7 - A", "7 - B", "9", "10", "Retail 1", "Retail 2"],
