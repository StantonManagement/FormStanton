...
This Addendum is incorporated into the Lease entered by and between Tenant and Landlord/lessor. Any conflict between the terms of the Lease and this Addendum shall be resolved in favor of this Addendum. Landlord and Tenant agree as follows:
...
You agree to cooperate and comply with any reporting and/or documenting process that we implement with respect to pet reporting and registration. We may, in our sole and absolute discretion, require an initial pet interview prior to your pet being in the premises.

By registering your pet with us, you are expressly consenting to our animal waste DNA testing program, which we will use to enforce our policies regarding pet waste disposal.

You acknowledge that you are responsible for securing your pet in the event that we or our agents enter the premises for any reason. Failure to secure your pet will result in a fine of $250 in addition to any damages incurred.

2. PROHIBITED ANIMALS/BREED. The following animals are categorically prohibited from the Property: Birds, Ferrets, Reptiles, Rodents, Rabbits, exotic animals, primates, farm animals, large fish tanks (over 20 gallons), and insects. We reserve the right to prohibit specific breeds of dogs and/or cats at any time in our sole and absolute discretion.

3. PET/ANIMAL RELATED FEES
• Pet Rent: $20-$50 per month (depending on pet type and weight)
• Non-refundable Pet Fee: $250
• Pet waste not picked up: $100 per occurrence
• Failure to secure pet: $250 per occurrence
• Unauthorized pet: $500 + removal requirement

4. PET VACCINATION REQUIREMENTS.
Dogs require: Rabies (Annual), DHPP, Bordetella, Leptospirosis, Canine Influenza
Cats require: Rabies (Annual), FVRCP, Feline Leukemia Virus (FeLV)

5. PET RECORD REQUIREMENTS. Prior to your pet entering the premises, you must provide:
(1) Proof of all vaccinations
(2) Proof of spay/neuter
(3) Photo of pet
(4) Pet DNA sample
(5) Emergency contact or local vet
(6) Proof that your renters insurance includes pet coverage

You understand and agree that you are liable for any and all damage to persons or property caused by your pet(s). You agree to indemnify and hold us harmless for any claim of injury to persons or property caused by your pet.`;

export const VEHICLE_ADDENDUM = `VEHICLE & PARKING ADDENDUM TO RENTAL AGREEMENT
