...
export async function GET(
  ...
  try {
    ...
    const { data: documents, error: docsError } = await supabaseAdmin
      ...
      .select('id, doc_type, label, required, display_order, person_slot, revision, status, file_name, rejection_reason, reviewed_at, scan_metadata, uploaded_by_role, staff_upload_note')
