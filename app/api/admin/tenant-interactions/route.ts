...
export async function POST(request: NextRequest) {
  try {
    ...
    const { tenant_name, building_address, unit_number, action_type, action_data, notes, performed_by } = body;

    if (!tenant_name || !building_address || !unit_number || !action_type || !performed_by) {
      return NextResponse.json(
