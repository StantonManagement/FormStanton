/**
 * PATCH /api/admin/workspaces/[workspaceId]/channel/stanton/messages/[messageId]
 * Edit a Stanton-private message — only author can edit within 5-minute window.
 */
...
export async function PATCH(
  ...
  await logAudit(
    ...
    messageId,
    { workspace_id: workspaceId, channel: 'stanton' },
    getClientIp(request)
  );
