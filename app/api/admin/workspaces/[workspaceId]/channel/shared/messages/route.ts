/**
 * GET/POST /api/admin/workspaces/[workspaceId]/channel/shared/messages
 * Shared channel — both Stanton and HACH read/write. Institutional record.
 */
...
export async function POST(
  ...
  await logAudit(
    ...
    message.id,
    { workspace_id: workspaceId, document_id: documentId, channel: 'shared', author_party_org: 'stanton' },
    getClientIp(request)
  );
