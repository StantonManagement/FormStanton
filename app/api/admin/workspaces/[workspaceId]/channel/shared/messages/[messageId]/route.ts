/**
 * PATCH /api/admin/workspaces/[workspaceId]/channel/shared/messages/[messageId]
 * Edit a shared message — only author can edit within 5-minute window.
 */
...
export async function PATCH(
  ...
  await logAudit(
    ...
    messageId,
    { workspace_id: workspaceId, channel: 'shared' },
    getClientIp(request)
  );
