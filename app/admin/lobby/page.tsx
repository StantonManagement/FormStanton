...
import { PermitReissuePanel, PermitHistoryLog } from '@/components/compliance/PermitReissuePanel';
              ...
              <>
                ...
                <div className="p-4 bg-[var(--bg-section)] border border-[var(--divider)]">
                  ...
                  {sub.permit_revoked && (
                    <div className="mb-3 p-3 bg-[var(--error)]/10 border border-[var(--error)]/40">
                      ...
                      <div className="mt-2 flex items-center gap-3">
                        ...
                        <PermitReissuePanel
                          submissionId={sub.id}
                          onSuccess={applySubmissionUpdate}
                  ...
                  {Array.isArray(sub.permit_history) && sub.permit_history.length > 0 && (
                    <PermitHistoryLog history={sub.permit_history} />
                  )}
                </div>
              </>
            ) : (
