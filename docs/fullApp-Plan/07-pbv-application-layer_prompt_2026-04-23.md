...
**Use with:** `07-pbv-application-layer_prd_2026-04-23.md`
**Mode:** Cascade
...
Read the PRD at `tasks/07-pbv-application-layer_prd_2026-04-23.md` before doing anything else. Also read the foundation PRD at `tasks/foundation-review_prd_2026-04-23.md` for context on what you are consuming.
