...
**Depends on:** `pbv-01-documents-decoupling-prd_2026-05-14.md` — must be merged first. Packet Intake writes to `application_documents`, which that PRD delivers. `stanton-workspace-document-lifecycle_prd_2026-05-13.md` for versioning, send-to-HACH, packet lock, audit timeline.
