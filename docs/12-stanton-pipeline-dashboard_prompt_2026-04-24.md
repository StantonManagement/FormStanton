...
**PRD:** `12-stanton-pipeline-dashboard_prd_2026-04-24.md` (read it first)
...
3. **Computed fields:**
   - `blocked_on` — server-computed from application state (use `application_documents WHERE anchor_type = 'pbv_full_application'` — PRD-11a decoupled from `form_submission_documents`):
