...
1. **`docs/01-pbv-02-packet-intake-prd_2026-05-14.md`** — entire document.
2. **`docs/shipped/pbv-01-documents-decoupling-prd_2026-05-14.md`** + its build report — for the `application_documents` table shape, revision contract, anchor pattern, and the seeding primitive.
3. **`docs/shipped/stanton-workspace-document-lifecycle_prd_2026-05-13.md`** — versioning model, `upload_source` enum, lifecycle behaviors on documents.
